            ...
            <div className="text-xs text-muted-foreground bg-background/30 p-3 rounded border border-primary/20">
              ...
              <div className="mb-3 pb-2 border-b border-primary/10">
                ...
                {nftStatus.details?.monad && (
                  <p className="text-xs text-green-400">
                    Balance: {nftStatus.details.monad.balance} NFT(s)
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                {nftStatus.details?.base && (
                  <p className="text-xs text-green-400">
                    Balance: {nftStatus.details.base.balance} NFT(s)
                  </p>
                )}
              </div>
            </div>
            ...
            {nftStatus.checked && !nftStatus.hasNFT && (
              <Alert className="bg-yellow-900/50 border-yellow-700">
                <AlertDescription className="text-yellow-200">
                  You need to own an NFT from one of the authorized collections (Monad Testnet or Base Mainnet) to access this service. Please acquire an NFT and try again.
                </AlertDescription>
              </Alert>
            )}
          </div>
